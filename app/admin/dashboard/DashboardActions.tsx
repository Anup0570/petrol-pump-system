    ...
    <>
      <div className="flex flex-wrap gap-4 mb-2">
        <motion.button 
          ...
          className="btn-primary px-5 py-3 text-sm font-bold shadow-sm cursor-pointer flex items-center gap-2"
        >
          <i className="fa-solid fa-truck"></i> Log Fuel Delivery
        </motion.button>
        <motion.button 
          whileHover={{ scale: 1.02, y: -1, boxShadow: "0 6px 16px rgba(16,185,129,0.2)" }}
          whileTap={{ scale: 0.98 }}
          onClick={() => router.push('/admin/entries')} 
          className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-5 py-3 text-sm rounded-xl cursor-pointer shadow-[0_2px_8px_rgba(16,185,129,0.15)] flex items-center gap-2 transition-all duration-200 border border-emerald-500/20"
        >
            ...
            >
              ...
              <h3 className="font-extrabold text-slate-800 mb-6 text-xl tracking-tight flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-orange-50 flex items-center justify-center border border-orange-100">
                  <i className="fa-solid fa-truck text-[#ff6a00]"></i>
                </div>
                Log Fuel Delivery
              </h3>
              ...
              <div className="flex gap-4">
                ...
                <motion.button 
                  ...
                  disabled={saving}
                  className="flex-1 py-3 btn-primary text-sm font-bold disabled:opacity-50 cursor-pointer"
                >
